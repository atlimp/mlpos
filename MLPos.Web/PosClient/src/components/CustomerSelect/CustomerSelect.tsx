    ...
    return (
        <div className="modal">
            <div className="modalContent customerSelection">
                <img className="back" src={leftArrow} onClick={() => { onSelectCustomer(-1) }} />
                <div className="customerList">
                    {customers.map((customer: Customer) => {
                        return (
                            <div className="customerCard" key={customer.id} onClick={() => onSelectCustomer(customer.id)}>
                                <div>
                                    <div className="customerImageContainer"><img src={customer.image}></img></div>
                                </div>

...
function TransactionList({ transactions, refreshTransactions }: TransactionListProps) {
    ...
    return <div className="container transactionSelectionContainer">
        {customerSelect && <CustomerSelect onSelectCustomer={onCustomerSelected}></CustomerSelect>}
        <div className="transactionSummaryContainer" onClick={() => { setCustomerSelect(true); } }>
